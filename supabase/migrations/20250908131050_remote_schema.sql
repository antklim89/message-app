...
ALTER TABLE ONLY "public"."subscribe"
    ADD CONSTRAINT "subscribe_pkey" PRIMARY KEY ("authorId", "subscribeId");
...
ALTER TABLE ONLY "public"."subscribe"
    ADD CONSTRAINT "subscribe_subscribeId_fkey" FOREIGN KEY ("subscribeId") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."subscribe" TO "anon";
GRANT ALL ON TABLE "public"."subscribe" TO "authenticated";
GRANT ALL ON TABLE "public"."subscribe" TO "service_role";
