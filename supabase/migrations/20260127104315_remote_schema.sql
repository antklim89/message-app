...
alter table "public"."messages" add constraint "messages_body_check" CHECK (((public.calculate_lexical_text_length(body) < 600) AND public.validate_message_body(body))) not valid;
