...
ALTER FUNCTION "utils"."extract_and_insert_hashtags"("lexical_node" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."hashtags_month_top_view" AS
 SELECT "hashtag",
    "count"(*) AS "count"
...
CREATE OR REPLACE VIEW "public"."hashtags_week_top_view" AS
 SELECT "hashtag",
    "count"(*) AS "count"
   FROM "public"."hashtags"
...
CREATE OR REPLACE TRIGGER "on_auth_user_created" AFTER INSERT ON "auth"."users" FOR EACH ROW EXECUTE FUNCTION "utils"."handle_new_user"();
