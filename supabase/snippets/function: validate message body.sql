create or replace function utils.validate_message_body (message_body jsonb) returns boolean LANGUAGE sql STABLE SECURITY DEFINER as $$ select extensions.jsonb_matches_schema(
  schema := '
{
  "type": "object",
  "properties": {
