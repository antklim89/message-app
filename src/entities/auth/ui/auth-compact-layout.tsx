...
import { Box, Button, HStack, IconButton, Skeleton, Text } from '@chakra-ui/react';
import { FaRightFromBracket, FaRightToBracket, FaUserPlus } from 'react-icons/fa6';
...
export const AuthCompactLayout = withSuspenseErrorBoundary(
  () => {
